...
const arrayOfPeople=[
  {name :'wahid',email:'wahid@gmail.com',age:40,favoriteFoods:['omlet','chapati']},
  {name :'wassime',email:'wassime@gmail.com',age:25,favoriteFoods:['mlewi']},
  {name: "saif", age: 55, favoriteFoods: ["kosksi"]},
  {name: "Hamza", age: 14, favoriteFoods: ["pizza"]}, 
];
...
findIdPerson('659c11f211236dd3f30909cd');
...
updateFoods('659c11f211236dd3f30909cd');
...
deletePerson('659c11f211236dd3f30909cd');
